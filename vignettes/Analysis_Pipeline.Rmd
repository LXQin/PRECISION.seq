...
This is the original code of analysis pipeline for the paper [*Statistical Assessment of Depth Normalization for Small RNA Sequencing*](https://pubmed.ncbi.nlm.nih.gov/32598180/), and the original data is included in the folder *PaperData*.
...
DE.voom = function(RC, groups, P = 0.01, normalized = TRUE, adjust = NULL) {
  ...
  out = out[order(out[,1]),]
  colnames(out) = c("Pvalue","log2.FC(PMFH/MXF)")
